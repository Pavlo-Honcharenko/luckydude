(function () {
    ...
    globe.projection.scale(800).translate([1000, 800]).rotate([0, -10, 0]);
    ...
    locations = locations.filter(x => x.CapitalLatitude != 0);
    ...
    setInterval(function () {
        ...
        globe.plugins.pings.add(location.CapitalLongitude, location.CapitalLatitude, { color: color, ttl: 1500, angle: 5 });
    }, 200);
